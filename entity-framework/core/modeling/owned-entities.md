...
> [!NOTE]
> Avant de EF Core `WithOwner()` méthode 3,0 n’existait pas, cet appel doit être supprimé. En outre, la clé primaire n’a pas été détectée automatiquement. elle a donc toujours été spécifiée.
