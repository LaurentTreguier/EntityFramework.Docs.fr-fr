...
L' [exemple d’intercepteur de mise en cache](https://github.com/dotnet/EntityFramework.Docs/tree/master/samples/core/Miscellaneous/CachingInterception) contient une application console simple qui interroge les messages quotidiens pour tester la mise en cache :
...
L' [exemple d’audit](https://github.com/dotnet/EntityFramework.Docs/tree/master/samples/core/Miscellaneous/SaveChangesInterception) utilise un DbContext simple avec les blogs et les publications.
...
L' [exemple d’audit](https://github.com/dotnet/EntityFramework.Docs/tree/master/samples/core/Miscellaneous/SaveChangesInterception) contient une application console simple qui apporte des modifications à la base de données de création de blogs, puis affiche l’audit qui a été créé.
