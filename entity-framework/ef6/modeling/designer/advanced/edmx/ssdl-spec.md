...
## <a name="association-element-ssdl"></a><span data-ttu-id="2f354-115">Association, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-115">Association Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="2f354-136">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-136">Example</span></span>
...
<span data-ttu-id="2f354-145">L’élément **AssociationSet** peut avoir les éléments enfants suivants (dans l’ordre indiqué) :</span><span class="sxs-lookup"><span data-stu-id="2f354-145">The **AssociationSet** element can have the following child elements (in the order listed):</span></span>
...
## <a name="collectiontype-element-ssdl"></a><span data-ttu-id="2f354-165">Élément CollectionType (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-165">CollectionType Element (SSDL)</span></span>
...
## <a name="commandtext-element-ssdl"></a><span data-ttu-id="2f354-174">CommandText, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-174">CommandText Element (SSDL)</span></span>
...
## <a name="definingquery-element-ssdl"></a><span data-ttu-id="2f354-183">DefiningQuery, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-183">DefiningQuery Element (SSDL)</span></span>
...
<span data-ttu-id="2f354-204">Le tableau suivant décrit les attributs qui peuvent être appliqués à l’élément **dépendant** .</span><span class="sxs-lookup"><span data-stu-id="2f354-204">The following table describes the attributes that can be applied to the **Dependent** element.</span></span>
...
## <a name="documentation-element-ssdl"></a><span data-ttu-id="2f354-217">Documentation, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-217">Documentation Element (SSDL)</span></span>
...
## <a name="end-element-ssdl"></a><span data-ttu-id="2f354-230">End, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-230">End Element (SSDL)</span></span>
...
#### <a name="applicable-attributes"></a><span data-ttu-id="2f354-270">Attributs applicables</span><span class="sxs-lookup"><span data-stu-id="2f354-270">Applicable Attributes</span></span>
...
### <a name="example"></a><span data-ttu-id="2f354-307">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-307">Example</span></span>
...
-   <span data-ttu-id="2f354-316">Documentation (zéro ou un élément) ;</span><span class="sxs-lookup"><span data-stu-id="2f354-316">Documentation (zero or one element)</span></span>
...
<span data-ttu-id="2f354-353">Le tableau ci-dessous décrit les attributs qui peuvent être appliqués à l’élément **EntityType** .</span><span class="sxs-lookup"><span data-stu-id="2f354-353">The table below describes the attributes that can be applied to the **EntityType** element.</span></span>
...
-   <span data-ttu-id="2f354-370">Documentation (zéro ou un élément) ;</span><span class="sxs-lookup"><span data-stu-id="2f354-370">Documentation (zero or one)</span></span>
...
| <span data-ttu-id="2f354-392">**Agrégat**</span><span class="sxs-lookup"><span data-stu-id="2f354-392">**Aggregate**</span></span>              | <span data-ttu-id="2f354-393">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-393">No</span></span>          | <span data-ttu-id="2f354-394">**True** si la procédure stockée retourne une valeur d’agrégation ; Sinon, **false**.</span><span class="sxs-lookup"><span data-stu-id="2f354-394">**True** if the stored procedure returns an aggregate value; otherwise **False**.</span></span>                                                                                                                                  |
...
<span data-ttu-id="2f354-429">L’élément **Key** peut avoir les éléments enfants suivants (dans l’ordre indiqué) :</span><span class="sxs-lookup"><span data-stu-id="2f354-429">The **Key** element can have the following child elements (in the order listed):</span></span>
...
<span data-ttu-id="2f354-440">Un élément **OnDelete** peut avoir les éléments enfants suivants (dans l’ordre indiqué) :</span><span class="sxs-lookup"><span data-stu-id="2f354-440">An **OnDelete** element can have the following child elements (in the order listed):</span></span>
...
|:---------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="2f354-468">**Nom**</span><span class="sxs-lookup"><span data-stu-id="2f354-468">**Name**</span></span>       | <span data-ttu-id="2f354-469">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-469">Yes</span></span>         | <span data-ttu-id="2f354-470">Nom du paramètre.</span><span class="sxs-lookup"><span data-stu-id="2f354-470">The name of the parameter.</span></span>                                                                                                                                                                                                      |
| <span data-ttu-id="2f354-471">**Type**</span><span class="sxs-lookup"><span data-stu-id="2f354-471">**Type**</span></span>       | <span data-ttu-id="2f354-472">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-472">Yes</span></span>         | <span data-ttu-id="2f354-473">Le type du paramètre.</span><span class="sxs-lookup"><span data-stu-id="2f354-473">The parameter type.</span></span>                                                                                                                                                                                                             |
| <span data-ttu-id="2f354-474">**Mode**</span><span class="sxs-lookup"><span data-stu-id="2f354-474">**Mode**</span></span>       | <span data-ttu-id="2f354-475">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-475">No</span></span>          | <span data-ttu-id="2f354-476">**In**, **out**ou **INOUT** selon que le paramètre est un paramètre d’entrée, de sortie ou d’entrée/sortie.</span><span class="sxs-lookup"><span data-stu-id="2f354-476">**In**, **Out**, or **InOut** depending on whether the parameter is an input, output, or input/output parameter.</span></span>                                                                                                                |
| <span data-ttu-id="2f354-477">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="2f354-477">**MaxLength**</span></span>  | <span data-ttu-id="2f354-478">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-478">No</span></span>          | <span data-ttu-id="2f354-479">Longueur maximale du paramètre.</span><span class="sxs-lookup"><span data-stu-id="2f354-479">The maximum length of the parameter.</span></span>                                                                                                                                                                                            |
| <span data-ttu-id="2f354-480">**Précision**</span><span class="sxs-lookup"><span data-stu-id="2f354-480">**Precision**</span></span>  | <span data-ttu-id="2f354-481">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-481">No</span></span>          | <span data-ttu-id="2f354-482">La précision du paramètre.</span><span class="sxs-lookup"><span data-stu-id="2f354-482">The precision of the parameter.</span></span>                                                                                                                                                                                                 |
| <span data-ttu-id="2f354-483">**Mettre à l'échelle**</span><span class="sxs-lookup"><span data-stu-id="2f354-483">**Scale**</span></span>      | <span data-ttu-id="2f354-484">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-484">No</span></span>          | <span data-ttu-id="2f354-485">L’échelle du paramètre.</span><span class="sxs-lookup"><span data-stu-id="2f354-485">The scale of the parameter.</span></span>                                                                                                                                                                                                     |
| <span data-ttu-id="2f354-486">**SRID**</span><span class="sxs-lookup"><span data-stu-id="2f354-486">**SRID**</span></span>       | <span data-ttu-id="2f354-487">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-487">No</span></span>          | <span data-ttu-id="2f354-488">Identificateur de référence système spatial.</span><span class="sxs-lookup"><span data-stu-id="2f354-488">Spatial System Reference Identifier.</span></span> <span data-ttu-id="2f354-489">Valide uniquement pour les paramètres des types spatiaux.</span><span class="sxs-lookup"><span data-stu-id="2f354-489">Valid only for parameters of spatial types.</span></span> <span data-ttu-id="2f354-490">Pour plus d’informations, consultez [SRID](https://en.wikipedia.org/wiki/SRID) et [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span><span class="sxs-lookup"><span data-stu-id="2f354-490">For more information, see [SRID](https://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |

> [!NOTE]
> <span data-ttu-id="2f354-491">Un nombre quelconque d’attributs d’annotation (attributs XML personnalisés) peut être appliqué à l’élément **Parameter** .</span><span class="sxs-lookup"><span data-stu-id="2f354-491">Any number of annotation attributes (custom XML attributes) may be applied to the **Parameter** element.</span></span> <span data-ttu-id="2f354-492">Toutefois, les attributs personnalisés ne peuvent pas appartenir à un espace de noms XML réservé pour le langage SSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-492">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="2f354-493">Les noms qualifiés complets de deux attributs personnalisés quelconques ne peuvent pas être identiques.</span><span class="sxs-lookup"><span data-stu-id="2f354-493">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="2f354-494">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-494">Example</span></span>

<span data-ttu-id="2f354-495">L’exemple suivant montre un élément **Function** qui possède deux éléments **Parameter** qui spécifient des paramètres d’entrée :</span><span class="sxs-lookup"><span data-stu-id="2f354-495">The following example shows a **Function** element that has two **Parameter** elements that specify input parameters:</span></span>
...
## <a name="principal-element-ssdl"></a><span data-ttu-id="2f354-496">Élément Principal (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-496">Principal Element (SSDL)</span></span>

<span data-ttu-id="2f354-497">L’élément **principal** en Store Schema Definition Language (SSDL) est un élément enfant de l’élément ReferentialConstraint qui définit la terminaison principale d’une contrainte de clé étrangère (également appelée contrainte référentielle).</span><span class="sxs-lookup"><span data-stu-id="2f354-497">The **Principal** element in store schema definition language (SSDL) is a child element to the ReferentialConstraint element that defines the principal end of a foreign key constraint (also called a referential constraint).</span></span> <span data-ttu-id="2f354-498">L’élément **principal** spécifie la ou les colonnes de clé primaire d’une table qui est référencée par une ou plusieurs colonnes.</span><span class="sxs-lookup"><span data-stu-id="2f354-498">The **Principal** element specifies the primary key column (or columns) in a table that is referenced by another column (or columns).</span></span> <span data-ttu-id="2f354-499">Les éléments **PropertyRef** spécifient les colonnes qui sont référencées.</span><span class="sxs-lookup"><span data-stu-id="2f354-499">**PropertyRef** elements specify which columns are referenced.</span></span> <span data-ttu-id="2f354-500">L’élément dépendant spécifie les colonnes qui référencent les colonnes de clés primaires spécifiées dans l’élément **principal** .</span><span class="sxs-lookup"><span data-stu-id="2f354-500">The Dependent element specifies columns that reference the primary key columns that are specified in the **Principal** element.</span></span>

<span data-ttu-id="2f354-501">L’élément **principal** peut avoir les éléments enfants suivants (dans l’ordre indiqué) :</span><span class="sxs-lookup"><span data-stu-id="2f354-501">The **Principal** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="2f354-502">PropertyRef (un ou plusieurs) ;</span><span class="sxs-lookup"><span data-stu-id="2f354-502">PropertyRef (one or more)</span></span>
-   <span data-ttu-id="2f354-503">éléments d'annotation (zéro, un ou plusieurs).</span><span class="sxs-lookup"><span data-stu-id="2f354-503">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="2f354-504">Attributs applicables</span><span class="sxs-lookup"><span data-stu-id="2f354-504">Applicable Attributes</span></span>

<span data-ttu-id="2f354-505">Le tableau suivant décrit les attributs qui peuvent être appliqués à l’élément **principal** .</span><span class="sxs-lookup"><span data-stu-id="2f354-505">The following table describes the attributes that can be applied to the **Principal** element.</span></span>

| <span data-ttu-id="2f354-506">Nom de l'attribut</span><span class="sxs-lookup"><span data-stu-id="2f354-506">Attribute Name</span></span> | <span data-ttu-id="2f354-507">Est obligatoire</span><span class="sxs-lookup"><span data-stu-id="2f354-507">Is Required</span></span> | <span data-ttu-id="2f354-508">Valeur</span><span class="sxs-lookup"><span data-stu-id="2f354-508">Value</span></span>                                                                                                                                                      |
|:---------------|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="2f354-509">**Rôle**</span><span class="sxs-lookup"><span data-stu-id="2f354-509">**Role**</span></span>       | <span data-ttu-id="2f354-510">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-510">Yes</span></span>         | <span data-ttu-id="2f354-511">La même valeur que l’attribut de **rôle** (s’il est utilisé) de l’élément de fin correspondant ; Sinon, le nom de la table qui contient la colonne référencée.</span><span class="sxs-lookup"><span data-stu-id="2f354-511">The same value as the **Role** attribute (if used) of the corresponding End element; otherwise, the name of the table that contains the referenced column.</span></span> |

> [!NOTE]
> <span data-ttu-id="2f354-512">Un nombre quelconque d’attributs d’annotation (attributs XML personnalisés) peut être appliqué à l’élément **principal** .</span><span class="sxs-lookup"><span data-stu-id="2f354-512">Any number of annotation attributes (custom XML attributes) may be applied to the **Principal** element.</span></span> <span data-ttu-id="2f354-513">Toutefois, les attributs personnalisés ne peuvent pas appartenir à un espace de noms XML réservé pour le langage CSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-513">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="2f354-514">Les noms qualifiés complets de deux attributs personnalisés quelconques ne peuvent pas être identiques.</span><span class="sxs-lookup"><span data-stu-id="2f354-514">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="2f354-515">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-515">Example</span></span>

<span data-ttu-id="2f354-516">L’exemple suivant montre un élément Association qui utilise un élément **ReferentialConstraint** pour spécifier les colonnes qui participent à la contrainte de clé étrangère \*\*FK \_ \*\* .</span><span class="sxs-lookup"><span data-stu-id="2f354-516">The following example shows an Association element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="2f354-517">L’élément **principal** spécifie la colonne **CustomerID** de la table **Customer** comme terminaison principale de la contrainte.</span><span class="sxs-lookup"><span data-stu-id="2f354-517">The **Principal** element specifies the **CustomerId** column of the **Customer** table as the principal end of the constraint.</span></span>
...
## <a name="property-element-ssdl"></a><span data-ttu-id="2f354-518">Property, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-518">Property Element (SSDL)</span></span>

<span data-ttu-id="2f354-519">L’élément de **propriété** en Store Schema Definition Language (SSDL) représente une colonne dans une table de la base de données sous-jacente.</span><span class="sxs-lookup"><span data-stu-id="2f354-519">The **Property** element in store schema definition language (SSDL) represents a column in a table in the underlying database.</span></span> <span data-ttu-id="2f354-520">Les éléments de **propriété** sont des enfants d’éléments EntityType, qui représentent des lignes dans une table.</span><span class="sxs-lookup"><span data-stu-id="2f354-520">**Property** elements are children of EntityType elements, which represent rows in a table.</span></span> <span data-ttu-id="2f354-521">Chaque élément de **propriété** défini sur un élément **EntityType** représente une colonne.</span><span class="sxs-lookup"><span data-stu-id="2f354-521">Each **Property** element defined on an **EntityType** element represents a column.</span></span>

<span data-ttu-id="2f354-522">Un élément de **propriété** ne peut pas avoir d’éléments enfants.</span><span class="sxs-lookup"><span data-stu-id="2f354-522">A **Property** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="2f354-523">Attributs applicables</span><span class="sxs-lookup"><span data-stu-id="2f354-523">Applicable Attributes</span></span>

<span data-ttu-id="2f354-524">Le tableau suivant décrit les attributs qui peuvent être appliqués à l’élément **Property** .</span><span class="sxs-lookup"><span data-stu-id="2f354-524">The following table describes the attributes that can be applied to the **Property** element.</span></span>

| <span data-ttu-id="2f354-525">Nom de l'attribut</span><span class="sxs-lookup"><span data-stu-id="2f354-525">Attribute Name</span></span>            | <span data-ttu-id="2f354-526">Est obligatoire</span><span class="sxs-lookup"><span data-stu-id="2f354-526">Is Required</span></span> | <span data-ttu-id="2f354-527">Valeur</span><span class="sxs-lookup"><span data-stu-id="2f354-527">Value</span></span>                                                                                                                                                                                                                           |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="2f354-528">**Nom**</span><span class="sxs-lookup"><span data-stu-id="2f354-528">**Name**</span></span>                  | <span data-ttu-id="2f354-529">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-529">Yes</span></span>         | <span data-ttu-id="2f354-530">Nom de la colonne correspondante.</span><span class="sxs-lookup"><span data-stu-id="2f354-530">The name of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="2f354-531">**Type**</span><span class="sxs-lookup"><span data-stu-id="2f354-531">**Type**</span></span>                  | <span data-ttu-id="2f354-532">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-532">Yes</span></span>         | <span data-ttu-id="2f354-533">Type de la colonne correspondante.</span><span class="sxs-lookup"><span data-stu-id="2f354-533">The type of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="2f354-534">**Nullable**</span><span class="sxs-lookup"><span data-stu-id="2f354-534">**Nullable**</span></span>              | <span data-ttu-id="2f354-535">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-535">No</span></span>          | <span data-ttu-id="2f354-536">**True** (valeur par défaut) ou **false** selon que la colonne correspondante peut avoir une valeur null ou non.</span><span class="sxs-lookup"><span data-stu-id="2f354-536">**True** (the default value) or **False** depending on whether the corresponding column can have a null value.</span></span>                                                                                                                  |
| <span data-ttu-id="2f354-537">**DefaultValue**</span><span class="sxs-lookup"><span data-stu-id="2f354-537">**DefaultValue**</span></span>          | <span data-ttu-id="2f354-538">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-538">No</span></span>          | <span data-ttu-id="2f354-539">Valeur par défaut de la colonne correspondante.</span><span class="sxs-lookup"><span data-stu-id="2f354-539">The default value of the corresponding column.</span></span>                                                                                                                                                                                  |
| <span data-ttu-id="2f354-540">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="2f354-540">**MaxLength**</span></span>             | <span data-ttu-id="2f354-541">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-541">No</span></span>          | <span data-ttu-id="2f354-542">Longueur maximale de la colonne correspondante.</span><span class="sxs-lookup"><span data-stu-id="2f354-542">The maximum length of the corresponding column.</span></span>                                                                                                                                                                                 |
| <span data-ttu-id="2f354-543">**Multiple**</span><span class="sxs-lookup"><span data-stu-id="2f354-543">**FixedLength**</span></span>           | <span data-ttu-id="2f354-544">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-544">No</span></span>          | <span data-ttu-id="2f354-545">**True** ou **false** selon que la valeur de colonne correspondante sera stockée en tant que chaîne de longueur fixe.</span><span class="sxs-lookup"><span data-stu-id="2f354-545">**True** or **False** depending on whether the corresponding column value will be stored as a fixed length string.</span></span>                                                                                                              |
| <span data-ttu-id="2f354-546">**Précision**</span><span class="sxs-lookup"><span data-stu-id="2f354-546">**Precision**</span></span>             | <span data-ttu-id="2f354-547">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-547">No</span></span>          | <span data-ttu-id="2f354-548">Précision de la colonne correspondante.</span><span class="sxs-lookup"><span data-stu-id="2f354-548">The precision of the corresponding column.</span></span>                                                                                                                                                                                      |
| <span data-ttu-id="2f354-549">**Mettre à l'échelle**</span><span class="sxs-lookup"><span data-stu-id="2f354-549">**Scale**</span></span>                 | <span data-ttu-id="2f354-550">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-550">No</span></span>          | <span data-ttu-id="2f354-551">Échelle de la colonne correspondante.</span><span class="sxs-lookup"><span data-stu-id="2f354-551">The scale of the corresponding column.</span></span>                                                                                                                                                                                          |
| <span data-ttu-id="2f354-552">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="2f354-552">**Unicode**</span></span>               | <span data-ttu-id="2f354-553">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-553">No</span></span>          | <span data-ttu-id="2f354-554">**True** ou **false** selon que la valeur de colonne correspondante sera stockée en tant que chaîne Unicode.</span><span class="sxs-lookup"><span data-stu-id="2f354-554">**True** or **False** depending on whether the corresponding column value will be stored as a Unicode string.</span></span>                                                                                                                   |
| <span data-ttu-id="2f354-555">**Classement**</span><span class="sxs-lookup"><span data-stu-id="2f354-555">**Collation**</span></span>             | <span data-ttu-id="2f354-556">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-556">No</span></span>          | <span data-ttu-id="2f354-557">Chaîne qui spécifie l’ordre de tri à utiliser dans la source de données.</span><span class="sxs-lookup"><span data-stu-id="2f354-557">A string that specifies the collating sequence to be used in the data source.</span></span>                                                                                                                                                   |
| <span data-ttu-id="2f354-558">**SRID**</span><span class="sxs-lookup"><span data-stu-id="2f354-558">**SRID**</span></span>                  | <span data-ttu-id="2f354-559">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-559">No</span></span>          | <span data-ttu-id="2f354-560">Identificateur de référence système spatial.</span><span class="sxs-lookup"><span data-stu-id="2f354-560">Spatial System Reference Identifier.</span></span> <span data-ttu-id="2f354-561">Valide uniquement pour les propriétés des types spatiaux.</span><span class="sxs-lookup"><span data-stu-id="2f354-561">Valid only for properties of spatial types.</span></span> <span data-ttu-id="2f354-562">Pour plus d’informations, consultez [SRID](https://en.wikipedia.org/wiki/SRID) et [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span><span class="sxs-lookup"><span data-stu-id="2f354-562">For more information, see [SRID](https://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |
| <span data-ttu-id="2f354-563">**StoreGeneratedPattern**</span><span class="sxs-lookup"><span data-stu-id="2f354-563">**StoreGeneratedPattern**</span></span> | <span data-ttu-id="2f354-564">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-564">No</span></span>          | <span data-ttu-id="2f354-565">**None**, **Identity** (si la valeur de colonne correspondante est une identité générée dans la base de données) ou **calculée** (si la valeur de colonne correspondante est calculée dans la base de données).</span><span class="sxs-lookup"><span data-stu-id="2f354-565">**None**, **Identity** (if the corresponding column value is an identity that is generated in the database), or **Computed** (if the corresponding column value is computed in the database).</span></span> <span data-ttu-id="2f354-566">Non valide pour les propriétés RowType.</span><span class="sxs-lookup"><span data-stu-id="2f354-566">Not Valid for RowType properties.</span></span> |

> [!NOTE]
> <span data-ttu-id="2f354-567">Un nombre quelconque d’attributs d’annotation (attributs XML personnalisés) peut être appliqué à l’élément **Property** .</span><span class="sxs-lookup"><span data-stu-id="2f354-567">Any number of annotation attributes (custom XML attributes) may be applied to the **Property** element.</span></span> <span data-ttu-id="2f354-568">Toutefois, les attributs personnalisés ne peuvent pas appartenir à un espace de noms XML réservé pour le langage SSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-568">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="2f354-569">Les noms qualifiés complets de deux attributs personnalisés quelconques ne peuvent pas être identiques.</span><span class="sxs-lookup"><span data-stu-id="2f354-569">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="2f354-570">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-570">Example</span></span>

<span data-ttu-id="2f354-571">L’exemple suivant montre un élément **EntityType** avec deux éléments de **propriété** enfants :</span><span class="sxs-lookup"><span data-stu-id="2f354-571">The following example shows an **EntityType** element with two child **Property** elements:</span></span>
...
## <a name="propertyref-element-ssdl"></a><span data-ttu-id="2f354-572">Élément PropertyRef (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-572">PropertyRef Element (SSDL)</span></span>

<span data-ttu-id="2f354-573">L’élément **PropertyRef** en Store Schema Definition Language (SSDL) fait référence à une propriété définie sur un élément EntityType pour indiquer que la propriété effectuera l’un des rôles suivants :</span><span class="sxs-lookup"><span data-stu-id="2f354-573">The **PropertyRef** element in store schema definition language (SSDL) references a property defined on an EntityType element to indicate that the property will perform one of the following roles:</span></span>

-   <span data-ttu-id="2f354-574">Faire partie de la clé primaire de la table représentée par l' **EntityType** .</span><span class="sxs-lookup"><span data-stu-id="2f354-574">Be part of the primary key of the table that the **EntityType** represents.</span></span> <span data-ttu-id="2f354-575">Un ou plusieurs éléments **PropertyRef** peuvent être utilisés pour définir une clé primaire.</span><span class="sxs-lookup"><span data-stu-id="2f354-575">One or more **PropertyRef** elements can be used to define a primary key.</span></span> <span data-ttu-id="2f354-576">Pour plus d'informations, consultez Élément Key.</span><span class="sxs-lookup"><span data-stu-id="2f354-576">For more information, see Key element.</span></span>
-   <span data-ttu-id="2f354-577">Faire partie de la terminaison dépendante ou principale d'une contrainte référentielle.</span><span class="sxs-lookup"><span data-stu-id="2f354-577">Be the dependent or principal end of a referential constraint.</span></span> <span data-ttu-id="2f354-578">Pour plus d'informations, consultez Élément ReferentialConstraint.</span><span class="sxs-lookup"><span data-stu-id="2f354-578">For more information, see ReferentialConstraint element.</span></span>

<span data-ttu-id="2f354-579">L’élément **PropertyRef** ne peut avoir que les éléments enfants suivants :</span><span class="sxs-lookup"><span data-stu-id="2f354-579">The **PropertyRef** element can only have the following child elements:</span></span>

-   <span data-ttu-id="2f354-580">Documentation (zéro ou un élément) ;</span><span class="sxs-lookup"><span data-stu-id="2f354-580">Documentation (zero or one)</span></span>
-   <span data-ttu-id="2f354-581">éléments d'annotation.</span><span class="sxs-lookup"><span data-stu-id="2f354-581">Annotation elements</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="2f354-582">Attributs applicables</span><span class="sxs-lookup"><span data-stu-id="2f354-582">Applicable Attributes</span></span>

<span data-ttu-id="2f354-583">Le tableau ci-dessous décrit les attributs qui peuvent être appliqués à l’élément **PropertyRef** .</span><span class="sxs-lookup"><span data-stu-id="2f354-583">The table below describes the attributes that can be applied to the **PropertyRef** element.</span></span>

| <span data-ttu-id="2f354-584">Nom de l'attribut</span><span class="sxs-lookup"><span data-stu-id="2f354-584">Attribute Name</span></span> | <span data-ttu-id="2f354-585">Est obligatoire</span><span class="sxs-lookup"><span data-stu-id="2f354-585">Is Required</span></span> | <span data-ttu-id="2f354-586">Valeur</span><span class="sxs-lookup"><span data-stu-id="2f354-586">Value</span></span>                                |
|:---------------|:------------|:-------------------------------------|
| <span data-ttu-id="2f354-587">**Nom**</span><span class="sxs-lookup"><span data-stu-id="2f354-587">**Name**</span></span>       | <span data-ttu-id="2f354-588">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-588">Yes</span></span>         | <span data-ttu-id="2f354-589">Nom de la propriété référencée.</span><span class="sxs-lookup"><span data-stu-id="2f354-589">The name of the referenced property.</span></span> |

> [!NOTE]
> <span data-ttu-id="2f354-590">Un nombre quelconque d’attributs d’annotation (attributs XML personnalisés) peut être appliqué à l’élément **PropertyRef** .</span><span class="sxs-lookup"><span data-stu-id="2f354-590">Any number of annotation attributes (custom XML attributes) may be applied to the **PropertyRef** element.</span></span> <span data-ttu-id="2f354-591">Toutefois, les attributs personnalisés ne peuvent pas appartenir à un espace de noms XML réservé pour le langage CSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-591">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="2f354-592">Les noms qualifiés complets de deux attributs personnalisés quelconques ne peuvent pas être identiques.</span><span class="sxs-lookup"><span data-stu-id="2f354-592">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="2f354-593">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-593">Example</span></span>

<span data-ttu-id="2f354-594">L’exemple suivant montre un élément **PropertyRef** utilisé pour définir une clé primaire en référençant une propriété définie sur un élément **EntityType** .</span><span class="sxs-lookup"><span data-stu-id="2f354-594">The following example shows a **PropertyRef** element used to define a primary key by referencing a property that is defined on an **EntityType** element.</span></span>
...
## <a name="referentialconstraint-element-ssdl"></a><span data-ttu-id="2f354-595">ReferentialConstraint, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-595">ReferentialConstraint Element (SSDL)</span></span>

<span data-ttu-id="2f354-596">L’élément **ReferentialConstraint** en Store Schema Definition Language (SSDL) représente une contrainte de clé étrangère (également appelée contrainte d’intégrité référentielle) dans la base de données sous-jacente.</span><span class="sxs-lookup"><span data-stu-id="2f354-596">The **ReferentialConstraint** element in store schema definition language (SSDL) represents a foreign key constraint (also called a referential integrity constraint) in the underlying database.</span></span> <span data-ttu-id="2f354-597">Les terminaisons principale et dépendante de la contrainte sont spécifiées respectivement par les éléments enfants Principal et Dependent.</span><span class="sxs-lookup"><span data-stu-id="2f354-597">The principal and dependent ends of the constraint are specified by the Principal and Dependent child elements, respectively.</span></span> <span data-ttu-id="2f354-598">Les colonnes qui participent aux terminaisons principale et dépendante sont référencées avec les éléments PropertyRef.</span><span class="sxs-lookup"><span data-stu-id="2f354-598">Columns that participate in the principal and dependent ends are referenced with PropertyRef elements.</span></span>

<span data-ttu-id="2f354-599">L’élément **ReferentialConstraint** est un élément enfant facultatif de l’élément Association.</span><span class="sxs-lookup"><span data-stu-id="2f354-599">The **ReferentialConstraint** element is an optional child element of the Association element.</span></span> <span data-ttu-id="2f354-600">Si un élément **ReferentialConstraint** n’est pas utilisé pour mapper la contrainte de clé étrangère spécifiée dans l’élément **Association** , un élément AssociationSetMapping doit être utilisé pour ce faire.</span><span class="sxs-lookup"><span data-stu-id="2f354-600">If a **ReferentialConstraint** element is not used to map the foreign key constraint that is specified in the **Association** element, an AssociationSetMapping element must be used to do this.</span></span>

<span data-ttu-id="2f354-601">L’élément **ReferentialConstraint** peut avoir les éléments enfants suivants :</span><span class="sxs-lookup"><span data-stu-id="2f354-601">The **ReferentialConstraint** element can have the following child elements:</span></span>

-   <span data-ttu-id="2f354-602">Documentation (zéro ou un élément) ;</span><span class="sxs-lookup"><span data-stu-id="2f354-602">Documentation (zero or one)</span></span>
-   <span data-ttu-id="2f354-603">Principal (exactement un élément) ;</span><span class="sxs-lookup"><span data-stu-id="2f354-603">Principal (exactly one)</span></span>
-   <span data-ttu-id="2f354-604">Dependent (exactement un élément) ;</span><span class="sxs-lookup"><span data-stu-id="2f354-604">Dependent (exactly one)</span></span>
-   <span data-ttu-id="2f354-605">éléments d'annotation (zéro, un ou plusieurs).</span><span class="sxs-lookup"><span data-stu-id="2f354-605">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="2f354-606">Attributs applicables</span><span class="sxs-lookup"><span data-stu-id="2f354-606">Applicable Attributes</span></span>

<span data-ttu-id="2f354-607">Un nombre quelconque d’attributs d’annotation (attributs XML personnalisés) peut être appliqué à l’élément **ReferentialConstraint** .</span><span class="sxs-lookup"><span data-stu-id="2f354-607">Any number of annotation attributes (custom XML attributes) may be applied to the **ReferentialConstraint** element.</span></span> <span data-ttu-id="2f354-608">Toutefois, les attributs personnalisés ne peuvent pas appartenir à un espace de noms XML réservé pour le langage SSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-608">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="2f354-609">Les noms qualifiés complets de deux attributs personnalisés quelconques ne peuvent pas être identiques.</span><span class="sxs-lookup"><span data-stu-id="2f354-609">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="2f354-610">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-610">Example</span></span>

<span data-ttu-id="2f354-611">L’exemple suivant montre un élément **Association** qui utilise un élément **ReferentialConstraint** pour spécifier les colonnes qui participent à la contrainte de clé étrangère \*\*FK \_ \*\* de la clé étrangère :</span><span class="sxs-lookup"><span data-stu-id="2f354-611">The following example shows an **Association** element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint:</span></span>
...
## <a name="returntype-element-ssdl"></a><span data-ttu-id="2f354-612">ReturnType, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-612">ReturnType Element (SSDL)</span></span>

<span data-ttu-id="2f354-613">L’élément **ReturnType** en Store Schema Definition Language (SSDL) spécifie le type de retour pour une fonction définie dans un élément **Function** .</span><span class="sxs-lookup"><span data-stu-id="2f354-613">The **ReturnType** element in store schema definition language (SSDL) specifies the return type for a function that is defined in a **Function** element.</span></span> <span data-ttu-id="2f354-614">Un type de retour de fonction peut également être spécifié avec un attribut **ReturnType** .</span><span class="sxs-lookup"><span data-stu-id="2f354-614">A function return type can also be specified with a **ReturnType** attribute.</span></span>

<span data-ttu-id="2f354-615">Le type de retour d’une fonction est spécifié à l’aide de l’attribut **type** ou de l’élément **ReturnType** .</span><span class="sxs-lookup"><span data-stu-id="2f354-615">The return type of a function is specified with the **Type** attribute or the **ReturnType** element.</span></span>

<span data-ttu-id="2f354-616">L’élément **ReturnType** peut avoir les éléments enfants suivants :</span><span class="sxs-lookup"><span data-stu-id="2f354-616">The **ReturnType** element can have the following child elements:</span></span>

- <span data-ttu-id="2f354-617">CollectionType (un)</span><span class="sxs-lookup"><span data-stu-id="2f354-617">CollectionType (one)</span></span>  

> [!NOTE]
> <span data-ttu-id="2f354-618">Un nombre quelconque d’attributs d’annotation (attributs XML personnalisés) peut être appliqué à l’élément **ReturnType** .</span><span class="sxs-lookup"><span data-stu-id="2f354-618">Any number of annotation attributes (custom XML attributes) may be applied to the **ReturnType** element.</span></span> <span data-ttu-id="2f354-619">Toutefois, les attributs personnalisés ne peuvent pas appartenir à un espace de noms XML réservé pour le langage SSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-619">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="2f354-620">Les noms qualifiés complets de deux attributs personnalisés quelconques ne peuvent pas être identiques.</span><span class="sxs-lookup"><span data-stu-id="2f354-620">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="2f354-621">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-621">Example</span></span>

<span data-ttu-id="2f354-622">L’exemple suivant utilise une **fonction** qui retourne une collection de lignes.</span><span class="sxs-lookup"><span data-stu-id="2f354-622">The following example uses a **Function** that returns a collection of rows.</span></span>
...
## <a name="rowtype-element-ssdl"></a><span data-ttu-id="2f354-623">RowType, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-623">RowType Element (SSDL)</span></span>

<span data-ttu-id="2f354-624">Un élément **RowType** en Store Schema Definition Language (SSDL) définit une structure sans nom comme type de retour pour une fonction définie dans le magasin.</span><span class="sxs-lookup"><span data-stu-id="2f354-624">A **RowType** element in store schema definition language (SSDL) defines an unnamed structure as a return type for a function defined in the store.</span></span>

<span data-ttu-id="2f354-625">Un élément **RowType** est l’élément enfant de l’élément **CollectionType** :</span><span class="sxs-lookup"><span data-stu-id="2f354-625">A **RowType** element is the child element of **CollectionType** element:</span></span>

<span data-ttu-id="2f354-626">Un élément **RowType** peut avoir les éléments enfants suivants :</span><span class="sxs-lookup"><span data-stu-id="2f354-626">A **RowType** element can have the following child elements:</span></span>

- <span data-ttu-id="2f354-627">Property (un ou plusieurs) ;</span><span class="sxs-lookup"><span data-stu-id="2f354-627">Property (one or more)</span></span>  

### <a name="example"></a><span data-ttu-id="2f354-628">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-628">Example</span></span>

<span data-ttu-id="2f354-629">L’exemple suivant montre une fonction de magasin qui utilise un élément **CollectionType** pour spécifier que la fonction retourne une collection de lignes (comme spécifié dans l’élément **RowType** ).</span><span class="sxs-lookup"><span data-stu-id="2f354-629">The following example shows a store function that uses a **CollectionType** element to specify that the function returns a collection of rows (as specified in the **RowType** element).</span></span>
...
## <a name="schema-element-ssdl"></a><span data-ttu-id="2f354-630">Schema, élément (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-630">Schema Element (SSDL)</span></span>

<span data-ttu-id="2f354-631">L’élément **Schema** en Store Schema Definition Language (SSDL) est l’élément racine d’une définition de modèle de stockage.</span><span class="sxs-lookup"><span data-stu-id="2f354-631">The **Schema** element in store schema definition language (SSDL) is the root element of a storage model definition.</span></span> <span data-ttu-id="2f354-632">Il contient des définitions pour les objets, les fonctions et les conteneurs qui composent un modèle de stockage.</span><span class="sxs-lookup"><span data-stu-id="2f354-632">It contains definitions for the objects, functions, and containers that make up a storage model.</span></span>

<span data-ttu-id="2f354-633">L’élément **Schema** peut contenir zéro, un ou plusieurs des éléments enfants suivants :</span><span class="sxs-lookup"><span data-stu-id="2f354-633">The **Schema** element may contain zero or more of the following child elements:</span></span>

-   <span data-ttu-id="2f354-634">Association</span><span class="sxs-lookup"><span data-stu-id="2f354-634">Association</span></span>
-   <span data-ttu-id="2f354-635">EntityType</span><span class="sxs-lookup"><span data-stu-id="2f354-635">EntityType</span></span>
-   <span data-ttu-id="2f354-636">EntityContainer</span><span class="sxs-lookup"><span data-stu-id="2f354-636">EntityContainer</span></span>
-   <span data-ttu-id="2f354-637">Fonction</span><span class="sxs-lookup"><span data-stu-id="2f354-637">Function</span></span>

<span data-ttu-id="2f354-638">L’élément **Schema** utilise l’attribut **namespace** pour définir l’espace de noms du type d’entité et des objets Association dans un modèle de stockage.</span><span class="sxs-lookup"><span data-stu-id="2f354-638">The **Schema** element uses the **Namespace** attribute to define the namespace for the entity type and association objects in a storage model.</span></span> <span data-ttu-id="2f354-639">Dans un espace de noms, deux objets ne peuvent pas avoir le même nom.</span><span class="sxs-lookup"><span data-stu-id="2f354-639">Within a namespace, no two objects can have the same name.</span></span>

<span data-ttu-id="2f354-640">Un espace de noms de modèle de stockage est différent de l’espace de noms XML de l’élément de **schéma** .</span><span class="sxs-lookup"><span data-stu-id="2f354-640">A storage model namespace is different from the XML namespace of the **Schema** element.</span></span> <span data-ttu-id="2f354-641">Un espace de noms de modèle de stockage (tel que défini par l’attribut d' **espace de noms** ) est un conteneur logique pour les types d’entités et les types d’association.</span><span class="sxs-lookup"><span data-stu-id="2f354-641">A storage model namespace (as defined by the **Namespace** attribute) is a logical container for entity types and association types.</span></span> <span data-ttu-id="2f354-642">L’espace de noms XML (indiqué par l’attribut **xmlns** ) d’un élément de **schéma** est l’espace de noms par défaut pour les éléments enfants et les attributs de l’élément de **schéma** .</span><span class="sxs-lookup"><span data-stu-id="2f354-642">The XML namespace (indicated by the **xmlns** attribute) of a **Schema** element is the default namespace for child elements and attributes of the **Schema** element.</span></span> <span data-ttu-id="2f354-643">Les espaces de noms XML de la forme https://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (où aaaa et mm représentent respectivement une année et un mois) sont réservés au langage SSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-643">XML namespaces of the form https://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (where YYYY and MM represent a year and month respectively) are reserved for SSDL.</span></span> <span data-ttu-id="2f354-644">Des éléments et attributs personnalisés ne peuvent pas être dans des espaces de noms de cette forme.</span><span class="sxs-lookup"><span data-stu-id="2f354-644">Custom elements and attributes cannot be in namespaces that have this form.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="2f354-645">Attributs applicables</span><span class="sxs-lookup"><span data-stu-id="2f354-645">Applicable Attributes</span></span>

<span data-ttu-id="2f354-646">Le tableau ci-dessous décrit les attributs qui peuvent être appliqués à l’élément **Schema** .</span><span class="sxs-lookup"><span data-stu-id="2f354-646">The table below describes the attributes can be applied to the **Schema** element.</span></span>

| <span data-ttu-id="2f354-647">Nom de l'attribut</span><span class="sxs-lookup"><span data-stu-id="2f354-647">Attribute Name</span></span>            | <span data-ttu-id="2f354-648">Est obligatoire</span><span class="sxs-lookup"><span data-stu-id="2f354-648">Is Required</span></span> | <span data-ttu-id="2f354-649">Valeur</span><span class="sxs-lookup"><span data-stu-id="2f354-649">Value</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="2f354-650">**Espace de noms**</span><span class="sxs-lookup"><span data-stu-id="2f354-650">**Namespace**</span></span>             | <span data-ttu-id="2f354-651">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-651">Yes</span></span>         | <span data-ttu-id="2f354-652">Espace de noms du modèle de stockage.</span><span class="sxs-lookup"><span data-stu-id="2f354-652">The namespace of the storage model.</span></span> <span data-ttu-id="2f354-653">La valeur de l’attribut d' **espace de noms** est utilisée pour former le nom qualifié complet d’un type.</span><span class="sxs-lookup"><span data-stu-id="2f354-653">The value of the **Namespace** attribute is used to form the fully qualified name of a type.</span></span> <span data-ttu-id="2f354-654">Par exemple, si un **EntityType** nommé *Customer* se trouve dans l’espace de noms ExampleModel. Store, le nom qualifié complet de l' **EntityType** est ExampleModel. Store. Customer.</span><span class="sxs-lookup"><span data-stu-id="2f354-654">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace, then the fully qualified name of the **EntityType** is ExampleModel.Store.Customer.</span></span> <br/> <span data-ttu-id="2f354-655">Les chaînes suivantes ne peuvent pas être utilisées comme valeur pour l’attribut d' **espace de noms** : **System**, **transient**ou **EDM**.</span><span class="sxs-lookup"><span data-stu-id="2f354-655">The following strings cannot be used as the value for the **Namespace** attribute: **System**, **Transient**, or **Edm**.</span></span> <span data-ttu-id="2f354-656">La valeur de l’attribut d' **espace de noms** ne peut pas être la même que la valeur de l’attribut d' **espace de noms** dans l’élément de schéma CSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-656">The value for the **Namespace** attribute cannot be the same as the value for the **Namespace** attribute in the CSDL Schema element.</span></span> |
| <span data-ttu-id="2f354-657">**Alias**</span><span class="sxs-lookup"><span data-stu-id="2f354-657">**Alias**</span></span>                 | <span data-ttu-id="2f354-658">Non</span><span class="sxs-lookup"><span data-stu-id="2f354-658">No</span></span>          | <span data-ttu-id="2f354-659">Identificateur utilisé à la place du nom de l'espace de noms.</span><span class="sxs-lookup"><span data-stu-id="2f354-659">An identifier used in place of the namespace name.</span></span> <span data-ttu-id="2f354-660">Par exemple, si un **EntityType** nommé *Customer* se trouve dans l’espace de noms ExampleModel. Store et que la valeur de l’attribut **alias** est *StorageModel*, vous pouvez utiliser StorageModel. Customer comme nom qualifié complet de l' **EntityType.**</span><span class="sxs-lookup"><span data-stu-id="2f354-660">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace and the value of the **Alias** attribute is *StorageModel*, then you can use StorageModel.Customer as the fully qualified name of the **EntityType.**</span></span>                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="2f354-661">**Fournisseur**</span><span class="sxs-lookup"><span data-stu-id="2f354-661">**Provider**</span></span>              | <span data-ttu-id="2f354-662">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-662">Yes</span></span>         | <span data-ttu-id="2f354-663">Fournisseur de données.</span><span class="sxs-lookup"><span data-stu-id="2f354-663">The data provider.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="2f354-664">**ProviderManifestToken**</span><span class="sxs-lookup"><span data-stu-id="2f354-664">**ProviderManifestToken**</span></span> | <span data-ttu-id="2f354-665">Oui</span><span class="sxs-lookup"><span data-stu-id="2f354-665">Yes</span></span>         | <span data-ttu-id="2f354-666">Jeton qui indique au fournisseur quel manifeste de fournisseur retourner.</span><span class="sxs-lookup"><span data-stu-id="2f354-666">A token that indicates to the provider which provider manifest to return.</span></span> <span data-ttu-id="2f354-667">Aucun format n'est défini pour le jeton.</span><span class="sxs-lookup"><span data-stu-id="2f354-667">No format for the token is defined.</span></span> <span data-ttu-id="2f354-668">Les valeurs du jeton sont définies par le fournisseur.</span><span class="sxs-lookup"><span data-stu-id="2f354-668">Values for the token are defined by the provider.</span></span> <span data-ttu-id="2f354-669">Pour plus d’informations sur les jetons de manifeste du fournisseur SQL Server, consultez SqlClient pour Entity Framework.</span><span class="sxs-lookup"><span data-stu-id="2f354-669">For information about SQL Server provider manifest tokens, see SqlClient for Entity Framework.</span></span>                                                                                                                                                                                                                                                                                                                        |

### <a name="example"></a><span data-ttu-id="2f354-670">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-670">Example</span></span>

<span data-ttu-id="2f354-671">L’exemple suivant illustre un élément de **schéma** qui contient un élément **EntityContainer** , deux éléments **EntityType** et un élément **Association** .</span><span class="sxs-lookup"><span data-stu-id="2f354-671">The following example shows a **Schema** element that contains an **EntityContainer** element, two **EntityType** elements, and one **Association** element.</span></span>
...
## <a name="annotation-attributes"></a><span data-ttu-id="2f354-672">Attributs d'annotation</span><span class="sxs-lookup"><span data-stu-id="2f354-672">Annotation Attributes</span></span>

<span data-ttu-id="2f354-673">Les attributs d'annotation en SSDL (Store Schema Definition Language) sont des attributs XML personnalisés dans le modèle de stockage qui fournissent des métadonnées supplémentaires concernant les éléments dans le modèle de stockage.</span><span class="sxs-lookup"><span data-stu-id="2f354-673">Annotation attributes in store schema definition language (SSDL) are custom XML attributes in the storage model that provide extra metadata about the elements in the storage model.</span></span> <span data-ttu-id="2f354-674">En plus d'avoir une structure XML valide, les contraintes suivantes s'appliquent aux attributs d'annotation :</span><span class="sxs-lookup"><span data-stu-id="2f354-674">In addition to having valid XML structure, the following constraints apply to annotation attributes:</span></span>

-   <span data-ttu-id="2f354-675">Les attributs d'annotation ne doivent pas figurer dans un espace de noms XML réservé pour le langage SSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-675">Annotation attributes must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="2f354-676">Les noms qualifiés complets de deux attributs d'annotation ne doivent pas être identiques.</span><span class="sxs-lookup"><span data-stu-id="2f354-676">The fully-qualified names of any two annotation attributes must not be the same.</span></span>

<span data-ttu-id="2f354-677">Plusieurs attributs d'annotation peuvent être appliqués à un élément SSDL donné.</span><span class="sxs-lookup"><span data-stu-id="2f354-677">More than one annotation attribute may be applied to a given SSDL element.</span></span> <span data-ttu-id="2f354-678">Vous pouvez accéder aux métadonnées contenues dans les éléments d’annotation au moment de l’exécution à l’aide des classes de l’espace de noms System. Data. Metadata. Edm.</span><span class="sxs-lookup"><span data-stu-id="2f354-678">Metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="2f354-679">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-679">Example</span></span>

<span data-ttu-id="2f354-680">L’exemple suivant montre un élément EntityType qui a un attribut d’annotation appliqué à la propriété **OrderID** .</span><span class="sxs-lookup"><span data-stu-id="2f354-680">The following example shows an EntityType element that has an annotation attribute applied to the **OrderId** property.</span></span> <span data-ttu-id="2f354-681">L’exemple montre également un élément d’annotation ajouté à l’élément **EntityType** .</span><span class="sxs-lookup"><span data-stu-id="2f354-681">The example also show an annotation element added to the **EntityType** element.</span></span>
...
## <a name="annotation-elements-ssdl"></a><span data-ttu-id="2f354-682">Éléments d'annotation (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-682">Annotation Elements (SSDL)</span></span>

<span data-ttu-id="2f354-683">Les éléments d'annotation en SSDL (Store Schema Definition Language) sont des éléments XML personnalisés dans le modèle de stockage qui fournissent des métadonnées supplémentaires concernant le modèle de stockage.</span><span class="sxs-lookup"><span data-stu-id="2f354-683">Annotation elements in store schema definition language (SSDL) are custom XML elements in the storage model that provide extra metadata about the storage model.</span></span> <span data-ttu-id="2f354-684">En plus d'avoir une structure XML valide, les contraintes suivantes s'appliquent aux éléments d'annotation :</span><span class="sxs-lookup"><span data-stu-id="2f354-684">In addition to having valid XML structure, the following constraints apply to annotation elements:</span></span>

-   <span data-ttu-id="2f354-685">Les éléments d'annotation ne doivent pas figurer dans un espace de noms XML réservé au langage SSDL.</span><span class="sxs-lookup"><span data-stu-id="2f354-685">Annotation elements must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="2f354-686">Les noms qualifiés complets de deux éléments d'annotation ne doivent pas être identiques.</span><span class="sxs-lookup"><span data-stu-id="2f354-686">The fully-qualified names of any two annotation elements must not be the same.</span></span>
-   <span data-ttu-id="2f354-687">Les éléments d'annotation doivent apparaître après tous les autres éléments enfants d'un élément SSDL donné.</span><span class="sxs-lookup"><span data-stu-id="2f354-687">Annotation elements must appear after all other child elements of a given SSDL element.</span></span>

<span data-ttu-id="2f354-688">Plusieurs éléments d'annotation peuvent être des enfants d'un élément SSDL donné.</span><span class="sxs-lookup"><span data-stu-id="2f354-688">More than one annotation element may be a child of a given SSDL element.</span></span> <span data-ttu-id="2f354-689">À partir de la .NET Framework version 4, les métadonnées contenues dans les éléments d’annotation sont accessibles au moment de l’exécution à l’aide des classes de l’espace de noms System. Data. Metadata. Edm.</span><span class="sxs-lookup"><span data-stu-id="2f354-689">Starting with the .NET Framework version 4, metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="2f354-690">Exemple</span><span class="sxs-lookup"><span data-stu-id="2f354-690">Example</span></span>

<span data-ttu-id="2f354-691">L’exemple suivant montre un élément EntityType qui a un élément annotation (**customelement**).</span><span class="sxs-lookup"><span data-stu-id="2f354-691">The following example shows an EntityType element that has an annotation element (**CustomElement**).</span></span> <span data-ttu-id="2f354-692">L’exemple montre également un attribut d’annotation appliqué à la propriété **OrderID** .</span><span class="sxs-lookup"><span data-stu-id="2f354-692">The example also shows an annotation attribute applied to the **OrderId** property.</span></span>
...
## <a name="facets-ssdl"></a><span data-ttu-id="2f354-693">Facettes (SSDL)</span><span class="sxs-lookup"><span data-stu-id="2f354-693">Facets (SSDL)</span></span>

<span data-ttu-id="2f354-694">Les facettes en SSDL (Store Schema Definition Language) représentent des contraintes sur les types de colonne spécifiés dans les éléments Property.</span><span class="sxs-lookup"><span data-stu-id="2f354-694">Facets in store schema definition language (SSDL) represent constraints on column types that are specified in Property elements.</span></span> <span data-ttu-id="2f354-695">Les facettes sont implémentées en tant qu’attributs XML sur les éléments de **propriété** .</span><span class="sxs-lookup"><span data-stu-id="2f354-695">Facets are implemented as XML attributes on **Property** elements.</span></span>

<span data-ttu-id="2f354-696">Le tableau ci-dessous décrit les facettes prises en charge dans le langage SSDL :</span><span class="sxs-lookup"><span data-stu-id="2f354-696">The following table describes the facets that are supported in SSDL:</span></span>

| <span data-ttu-id="2f354-697">Facette</span><span class="sxs-lookup"><span data-stu-id="2f354-697">Facet</span></span>           | <span data-ttu-id="2f354-698">Description</span><span class="sxs-lookup"><span data-stu-id="2f354-698">Description</span></span>                                                                                                                                                                                                                                                 |
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="2f354-699">**Classement**</span><span class="sxs-lookup"><span data-stu-id="2f354-699">**Collation**</span></span>   | <span data-ttu-id="2f354-700">Spécifie la table de classement ou ordre de tri à utiliser lors de l'exécution d'opérations de comparaison et de tri sur des valeurs de la propriété.</span><span class="sxs-lookup"><span data-stu-id="2f354-700">Specifies the collating sequence (or sorting sequence) to be used when performing comparison and ordering operations on values of the property.</span></span>                                                                                                             |
| <span data-ttu-id="2f354-701">**Multiple**</span><span class="sxs-lookup"><span data-stu-id="2f354-701">**FixedLength**</span></span> | <span data-ttu-id="2f354-702">Spécifie si la longueur de la valeur de colonne peut varier.</span><span class="sxs-lookup"><span data-stu-id="2f354-702">Specifies whether the length of the column value can vary.</span></span>                                                                                                                                                                                                  |
| <span data-ttu-id="2f354-703">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="2f354-703">**MaxLength**</span></span>   | <span data-ttu-id="2f354-704">Spécifie la longueur maximale de la valeur de colonne.</span><span class="sxs-lookup"><span data-stu-id="2f354-704">Specifies the maximum length of the column value.</span></span>                                                                                                                                                                                                           |
| <span data-ttu-id="2f354-705">**Précision**</span><span class="sxs-lookup"><span data-stu-id="2f354-705">**Precision**</span></span>   | <span data-ttu-id="2f354-706">Pour les propriétés de type **Decimal**, spécifie le nombre de chiffres qu’une valeur de propriété peut avoir.</span><span class="sxs-lookup"><span data-stu-id="2f354-706">For properties of type **Decimal**, specifies the number of digits a property value can have.</span></span> <span data-ttu-id="2f354-707">Pour les propriétés de type **Time**, **DateTime**et **DateTimeOffset**, spécifie le nombre de chiffres pour la partie fractionnaire des secondes de la valeur de colonne.</span><span class="sxs-lookup"><span data-stu-id="2f354-707">For properties of type **Time**, **DateTime**, and **DateTimeOffset**, specifies the number of digits for the fractional part of seconds of the column value.</span></span> |
| <span data-ttu-id="2f354-708">**Mettre à l'échelle**</span><span class="sxs-lookup"><span data-stu-id="2f354-708">**Scale**</span></span>       | <span data-ttu-id="2f354-709">Spécifie le nombre de chiffres à droite de la virgule décimale pour la valeur de colonne.</span><span class="sxs-lookup"><span data-stu-id="2f354-709">Specifies the number of digits to the right of the decimal point for the column value.</span></span>                                                                                                                                                                      |
| <span data-ttu-id="2f354-710">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="2f354-710">**Unicode**</span></span>     | <span data-ttu-id="2f354-711">Indique si la valeur de colonne est stockée au format Unicode.</span><span class="sxs-lookup"><span data-stu-id="2f354-711">Indicates whether the column value is stored as Unicode.</span></span>                                                                                                                                                                                                    |
